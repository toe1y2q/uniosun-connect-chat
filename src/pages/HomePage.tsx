    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="px-4 lg:px-6 h-16 flex items-center border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <Button 
            ...
            className="bg-green-600 hover:bg-green-700 text-sm px-3 py-2 md:text-base md:px-4 md:py-2"
          >
            Get Started
      ...
      <section className="px-4 py-12 md:py-24 lg:py-32">
        <div className="container mx-auto text-center">
          ...
          <motion.h1 
            className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-green-600 leading-tight"
            {...fadeInUp}
          >
          ...
          >
            <Button 
              onClick={onGetStarted}
              size="lg" 
              className="bg-green-600 hover:bg-green-700 text-lg px-8 py-4 h-auto w-full sm:w-auto"
            >
              Join Hireveno Today
