    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <header className="px-4 lg:px-6 h-16 flex items-center border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <Button onClick={onGetStarted} className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700">
            Get Started
      ...
      <section className="px-4 py-12 md:py-24 lg:py-32">
        <div className="container mx-auto text-center">
          ...
          <motion.h1 
            className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 bg-clip-text text-transparent leading-tight"
            {...fadeInUp}
          >
          ...
          >
            <Button 
              ...
              size="lg" 
              className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-lg px-8 py-4 h-auto w-full sm:w-auto"
            >
              Join Hireveno Today
      ...
      {/* How It Works */}
      <section className="px-4 py-16 bg-gradient-to-br from-green-50 to-blue-50">
        <div className="container mx-auto">
          <motion.div className="text-center mb-12" {...fadeInUp}>
          ...
          >
            {[
              { step: "1", title: "Sign Up", description: "Create your account as a student or aspirant" },
              { step: "2", title: "Get Verified", description: "Complete verification and take department quiz (for students)" },
              { step: "3", title: "Browse & Book", description: "Find verified tutors and book sessions" },
              { step: "4", title: "Learn & Grow", description: "Attend sessions and achieve your academic goals" }
            ].map((item, index) => (
              <motion.div key={index} variants={fadeInUp} className="text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-green-600 to-blue-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                  {item.step}
                </div>
      ...
      {/* CTA Section */}
      <section className="px-4 py-16 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="container mx-auto text-center">
          <motion.div {...fadeInUp}>
