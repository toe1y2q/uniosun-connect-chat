    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 p-3 sm:p-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">Manage UNIOSUN Connect Platform</p>
            </div>
              ...
              <Card className="border-green-200 hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-1">User Management</h3>
                      <p className="text-xs sm:text-sm text-gray-600">Manage all platform users</p>
                    </div>
                    <Users className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 opacity-20" />
                  </div>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/admin/withdrawals">
              <Card className="border-green-200 hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-1">Withdrawal Management</h3>
                      <p className="text-xs sm:text-sm text-gray-600">Monitor withdrawal requests</p>
                    </div>
                    <Wallet className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 opacity-20" />
                  </div>
                </CardContent>
              </Card>
            </Link>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6 mb-6 sm:mb-8">
              ...
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xl sm:text-3xl font-bold text-green-600">{userStats?.totalStudents || 0}</p>
                  </div>
                  <GraduationCap className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 opacity-20" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-green-200">
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-600">Total Aspirants</p>
                    <p className="text-xl sm:text-3xl font-bold text-green-600">{userStats?.totalAspirants || 0}</p>
                  </div>
                  <Users className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 opacity-20" />
                </div>
              </CardContent>
            ...
            <Card className="border-green-200">
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-600">Verified Students</p>
                    <p className="text-xl sm:text-3xl font-bold text-green-600">{userStats?.verifiedStudents || 0}</p>
                  </div>
            ...
            <Card className="border-green-200">
              <CardContent className="p-3 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs sm:text-sm font-medium text-gray-600">Active Talents</p>
                    <p className="text-xl sm:text-3xl font-bold text-green-600">{userStats?.badgedStudents || 0}</p>
                  </div>
                  <BarChart3 className="w-8 h-8 sm:w-12 sm:h-12 text-green-600 opacity-20" />
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <Tabs defaultValue="verification" className="space-y-4 sm:space-y-6">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-5 bg-green-100 h-auto">
            <TabsTrigger value="verification" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs sm:text-sm p-2 sm:p-3">
              Student Verification
            </TabsTrigger>
            <TabsTrigger value="moderation" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs sm:text-sm p-2 sm:p-3">
              <Flag className="w-3 h-3 sm:w-4 sm:h-4 mr-1" />
              Moderation
            </TabsTrigger>
            <TabsTrigger value="users" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs sm:text-sm p-2 sm:p-3">
              User Management
            </TabsTrigger>
            <TabsTrigger value="sessions" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs sm:text-sm p-2 sm:p-3">
              Session Monitoring
            </TabsTrigger>
            <TabsTrigger value="analytics" className="data-[state=active]:bg-green-600 data-[state=active]:text-white text-xs sm:text-sm p-2 sm:p-3">
              Analytics
            </TabsTrigger>
          </TabsList>
              ...
              <CardContent>
                {pendingStudents?.length ? (
                  <div className="space-y-3 sm:space-y-4">
                    {pendingStudents.map((student) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 border border-green-200 rounded-lg hover:bg-green-50 gap-3"
                      >
                        ...
                        <div className="flex items-center gap-2 sm:gap-2">
                          ...
                          <Button variant="ghost" size="sm" className="text-green-600 hover:bg-green-50 hidden sm:flex">
                  ...
                  <div className="text-center py-6 sm:py-8">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold mb-2">No pending verifications</h3>
          ...
          <TabsContent value="users" className="space-y-4 sm:space-y-6">
            <Card className="border-green-200">
              <CardHeader>
                <CardTitle className="text-green-800 text-base sm:text-lg">User Management</CardTitle>
                <CardDescription className="text-xs sm:text-sm">Manage all platform users</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-6 sm:py-8">
                  <Users className="w-10 h-10 sm:w-12 sm:h-12 text-green-400 mx-auto mb-4" />
                  <h3 className="text-base sm:text-lg font-semibold mb-2">Advanced User Management</h3>
          ...
          <TabsContent value="sessions" className="space-y-4 sm:space-y-6">
            <Card className="border-green-200">
              <CardHeader>
                <CardTitle className="text-green-800 text-base sm:text-lg">Recent Sessions</CardTitle>
                <CardDescription className="text-xs sm:text-sm">Monitor platform activity and sessions</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="analytics" className="space-y-4 sm:space-y-6">
            <Card className="border-green-200">
              <CardHeader>
                <CardTitle className="text-green-800 text-base sm:text-lg">Platform Analytics</CardTitle>
                <CardDescription className="text-xs sm:text-sm">View detailed platform statistics and trends</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-6 sm:py-8">
                  <BarChart3 className="w-10 h-10 sm:w-12 sm:h-12 text-green-400 mx-auto mb-4" />
