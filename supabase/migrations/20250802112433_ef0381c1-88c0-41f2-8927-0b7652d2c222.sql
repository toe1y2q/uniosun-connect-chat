...
DROP TRIGGER IF EXISTS release_payment_on_review_trigger ON reviews;
CREATE TRIGGER release_payment_on_review_trigger
  AFTER INSERT ON reviews
  FOR EACH ROW
  EXECUTE FUNCTION release_payment_on_review();